...
export const en = {
    ...
    header: {
        ...
        online: "Online",
        defaultSubtitle: "Professional Automation Toolkit",
    ...
    fileFormatConverter: {
        ...
        uploadDescription: "Upload Word, PowerPoint, or Excel files for conversion",
        dropDocuments: "Drop documents here or click to upload",
        dropActive: "Drop the files here...",
        supportedFormats: "Supports DOC, DOCX, PPT, PPTX, XLS, XLSX formats",
