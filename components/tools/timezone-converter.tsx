      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="border-l-4 border-l-[color:var(--productivity)]">
          ...
          <CardContent>
            ...
            <p className="text-sm text-muted-foreground">Time conversion</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-blue-500">
          <CardHeader className="pb-3">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-lg">World Clocks</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Track time across multiple time zones</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="border-t pt-4 space-y-3">
              <div className="space-y-2">
                <Label htmlFor="new-clock-label">Clock Label</Label>
                <Input
                  id="new-clock-label"
                  value={newClockLabel}
